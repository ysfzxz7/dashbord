...
{
    return (
        <div className="flex px-2  border  bg-gray-200 py-3 h-auto overflow-scroll " >
            <div className="">
                <h2 className="text-orange-600 bg-yellow-300 rounded-full w-fit px-2 cursor-pointer">To do</h2>

                    {todoData.map((item, index)=>(
                       <div className=" border border-gray-300 my-2 rounded-2xl px-3 py-2 bg-white relative">
            ...
            <div className="">
                <h2 className="text-orange-600 bg-yellow-300 rounded-full w-fit px-2 cursor-pointer">To do</h2>
                    ...
                    {inProgressData.map((item, index)=>(
                       <div className=" border border-gray-300 my-2 rounded-2xl px-3 py-2 mx-2 bg-white relative">
                        <p className="text-sm indent-6 py-3">{item.comment}</p>
                        <div className="flex items-center">
                        <RiSaveFill className="text-blue-900 text-2xl" />
                        <FaAngleDoubleUp  className="text-red-600 text-2xl mx-3"/>
